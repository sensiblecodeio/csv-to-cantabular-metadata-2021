# This is a utility script for normalising the timestamps in README.md and CENSUS_METADATA.md
# It is used during development
# Run from base directory:
# ./util/normalise_docs.sh
...
sed -i -r 's/[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{6}/2022-01-01T00:00:00.000000/g' CENSUS_METADATA.md
