...
class TestBestEffort(unittest.TestCase):
    ...
    def test_generated_json_best_effort(self, mock_datetime):
        ...
        self.assertRegex(infos[8], r'Build created=1970-01-01T00:00:00 best_effort=True dataset_filter="" geography_file="" versions_data=30 versions_schema=1.3 versions_script=1.3.2')
